...
if gift_value < 5000:
    ...
    tax_cost = 100 + (gift_value - 5000) * 0.08
    print(f"Amount of tax: {tax_cost} euros")
elif gift_value >= 25000 and gift_value < 50000:
    tax_cost = 1700 + (gift_value - 25000) * 0.10
    print(f"Amount of tax: {tax_cost} euros")
elif gift_value >= 55000 and gift_value < 200000:
    tax_cost = 4700 + (gift_value - 55000) * 0.12
    print(f"Amount of tax: {tax_cost} euros")
elif gift_value >= 200000 and gift_value < 1000000:
    tax_cost = 22100 + (gift_value - 200000) * 0.15
    print(f"Amount of tax: {tax_cost} euros")
elif gift_value >= 1000000:
    tax_cost = 142100 + (gift_value - 1000000) * 0.17
    print(f"Amount of tax: {tax_cost} euros")
